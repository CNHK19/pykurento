...
kurento_room.controller('loginController', function($scope, $rootScope, $http, 
    ...
    $http.get($rootScope.contextpath + '/room/getAllRooms').success(function(data, status, headers, config) {
        console.log(JSON.stringify(data));
        $scope.listRooms = data;
    }).error(function(data, status, headers, config) {});

    $http.get($rootScope.contextpath + '/room/getClientConfig').success(function(data, status, headers, config) {
        console.log(JSON.stringify(data));
        $scope.clientConfig = data;
    }).error(function(data, status, headers, config) {});

    $http.get($rootScope.contextpath + '/room/getUpdateSpeakerInterval').success(function(data, status, headers, config) {
        $scope.updateSpeakerInterval = data
    }).error(function(data, status, headers, config) {});

    $http.get($rootScope.contextpath + '/room/getThresholdSpeaker').success(function(data, status, headers, config) {
